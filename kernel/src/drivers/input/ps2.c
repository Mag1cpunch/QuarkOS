...
void initKeyboard() {
    ...
    configuration_byte = readPS2RAM(0);
    printf("Configuration byte from 1\n");
    printf("%d\n", configuration_byte);
    if (two_channel) {
        ...
        switch (port2_status) {
            case 0x00:
                ...
                configuration_byte = readPS2RAM(0);
                printf("Configuration byte from 2\n");
                printf("%d\n", configuration_byte);
                break;
            case 0x01:
                // clock line stuck low
